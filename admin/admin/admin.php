            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12  ">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Admin <small>Hanya Pengurus RT yang menjadi admin</small> </h2>
                            ...
                            <div class="container">
                                <h5>
                                    <a href="tambahadmin.php"><span class="badge badge-success">Tambah Admin</span></a>
                                </h5>
                            </div>
                            <div class="x_content">
                                <div class="table-responsive">
                                    <table class="table table-striped jambo_table bulk_action">
                                        ...
                                        <tbody>
                                            <?php
                                            $data = mysqli_query($koneksi, "select * from kepala_keluarga where rules='admin'");
                                            ...
                                            ?>
                                                <tr class="even pointer">
                                                    ...
                                                    <td class=" last"> <a href="infoadmin.php?id=<?php echo $d['id']; ?>" class="badge badge-info">INFO</a>
                                                        <a href="editadmin.php?id=<?php echo $d['id']; ?>" class="badge badge-success">EDIT</a>
                                                        <a href="hapusadmin.php?id=<?php echo $d['id']; ?>" class="badge badge-danger">HAPUS</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }

                                    ...
                                    <table class="table table-striped jambo_table bulk_action">
                                        <thead>
                                            <tr class="headings">
                                                ...
                                                <th class="column-title">Jenkel </th>
                                                <th class="column-title">Tanggal Lahir </th>
                                                <th class="column-title">Pernikahan </th>
                                        ...
                                        <tbody>
                                            <?php
                                            $data = mysqli_query($koneksi, "select * from data_warga");
                                            ...
                                            ?>
                                                <tr class="even pointer">
                                                    ...
                                                    <td class=" "><?php echo $d['nikah']; ?></td>
                                                    <td class=" last"> <a href="infowarga.php?id=<?php echo $d['id']; ?>" class="badge badge-info">INFO</a>
                                                        <a href="editwarga.php?id=<?php echo $d['id']; ?>" class="badge badge-success">EDIT</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }

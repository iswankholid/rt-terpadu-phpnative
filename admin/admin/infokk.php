            ...
            <div class="right_col" role="main">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12  ">
                        <div class="mb-3 badge badge-warning">
                            <a href="kkeluarga.php">
                                << kembali</a>
                        </div>
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped jambo_table bulk_action">
                                        ...
                                        <tbody>
                                            <?php
                                            $id = $_GET['kk'];
                                            $data = mysqli_query($koneksi, "select * from data_warga where kk='$id'");
                                            ...
                                            ?>
                                                <tr class="even pointer">
                                                    ...
                                                    <td class=" "><?php echo $d['tmp_lahir'] . ',' . $d['tgl_lahir']; ?></td>
                                                    <td class=" "><?php echo $d['pekerjaan']; ?></td>
                                                    <td class=" "><?php echo $d['status']; ?></td>
